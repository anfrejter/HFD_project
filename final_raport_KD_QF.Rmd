...
$\sum_{i = q_{1}}^{q_{n}} stat_{i}$ where $stat_{i}$ is the statistic of the strategy for quarter $q_{i}$.
...
-   **Out-of-sample Data**: Four out of five quarters were **highly unprofitable**, reinforcing the idea that the strategy may have overfitted to the in-sample data. Overal net loss on out of sample data was around -19,100.
